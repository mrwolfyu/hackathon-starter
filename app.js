...
console.log("MAREW @#@#@# " + passportConfig.isAdmin || passportConfig.isListener);
app.get('/play/:id/:orig',  (passportConfig.isAdmin || passportConfig.isListener), bbbController.playRecordingsById);
